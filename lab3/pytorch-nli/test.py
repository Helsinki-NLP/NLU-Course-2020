...
from corpora import MultiNLI, SciTail, StanfordNLI, AllNLI, BreakingNLI, RTE
...
parser.add_argument("--corpus",
                    type=str,
                    choices=['snli', 'breaking_nli', 'all_nli', 'multinli_matched', 'multinli_mismatched', 'scitail', 'rte'],
                    default='snli')
...
def main():
    ...
    if config.corpus == 'multinli_matched':
        ...
        train, dev, test = RTE.splits(inputs, labels)
        id_field.build_vocab(train, dev, test)
